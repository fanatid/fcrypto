...
module.exports = (Secp256k1) => {
  ...
  return {
    ...
    publicKeyCreate (seckey, compressed = true, output = (len) => new Uint8Array(len)) {
      assert(instance !== null, 'Secp256k1 should be initialized first')
      ...
      switch (instance.publicKeyCreate(output, seckey, outputlen)) {
        ...
        case 1: throw new Error('Private Key is invalid')
        case 2: throw new Error('Public Key serialization error')
      }
    },
    ...
    ecdsaSign (msg32, seckey, output = (len) => new Uint8Array(len)) {
      ...
      switch (instance.ecdsaSign(sig, msg32, seckey)) {
        case 0: return sig
        case 1: throw new Error('The nonce generation function failed, or the private key was invalid')
      }
    },
    ...
    ecdsaVerify (signagure, msg32, pubkey) {
      ...
      switch (instance.ecdsaVerify(signagure, msg32, pubkey)) {
        case 0: return true
        case 1: throw new Error('Signature could not be parsed')
        case 2: throw new Error('The public key could not be parsed')
        case 3: throw new Error('Incorrect or unparseable signature')
      }
    },
  }
}
