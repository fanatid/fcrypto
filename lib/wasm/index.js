module.exports = async () => {
  ...
  const { heapu8, importObject, exportMap } = require('./wasm-glue')
  ...
  return {
    publicKeyCreate(pubkey, seckey) {
      ...
      const ret = fns[exportMap.fcrypto_secp256k1_pubkey_create](
        ctx,
        ptr33,
        ptr32_1,
        1
    ...
    ecdsaSign(sig, msg32, seckey) {
      ...
      const ret = fns[exportMap.fcrypto_secp256k1_ecdsa_sign](
        ctx,
        ptr64,
        ptr4,
        ptr32_1,
    ...
    ecdsaVerify(sig, msg32, pubkey) {
      ...
      return fns[exportMap.fcrypto_secp256k1_ecdsa_verify](
        ctx,
        ptr64,
        ptr32_1,
        ptr33,
